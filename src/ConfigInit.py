...
def _cachedChoices(cache_attr, default_choices):
...
select_all = [("all", "all")]
config.plugins.piconcockpit.size = ConfigSelection(default="all", choices=_cachedChoices('cached_sizes', select_all))
config.plugins.piconcockpit.bit = ConfigSelection(default="all", choices=_cachedChoices('cached_bits', select_all))
config.plugins.piconcockpit.creator = ConfigSelection(default="all", choices=_cachedChoices('cached_creators', select_all))
config.plugins.piconcockpit.satellite = ConfigSelection(default="all", choices=_cachedChoices('cached_satellites', select_all))
